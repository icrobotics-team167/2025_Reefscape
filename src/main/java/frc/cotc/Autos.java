...
public class Autos {
  ...
  private AutoRoutine createRoutine(
    ...
    nameBuilder.append("Autogenerated Routine: ");
    nameBuilder.append(initialBranch.name());
    for (var branch : cyclingBranches) {
      nameBuilder.append(branch.name());
    }
    var routine = factory.newRoutine(nameBuilder.toString());
    ...
    routine
        ...
        .onTrue(
            sequence(
                ...
                .deadlineFor(reefRepulsorCommand.goTo(initialBranch))
...
//                  .withTimeout(.5) // ONLY RUN IN SIM
                  .deadlineFor(sourceRepulsorCommand.goTo(source))
              ...
              superstructure
                  ...
                  .deadlineFor(
                      waitUntil(sourceToReef[i].done())
                          .andThen(reefRepulsorCommand.goTo(cyclingBranches[i]).asProxy()))
